...
import { ChildrenProfilesModule } from './modules/children-profiles/children-profiles.module';
...
export class AppModule {
  ...
  constructor(private moduleManager: ModuleManagerService) {
    AppModule.logger.log('AppModule inicializado - Letrito');
    ...
    AppModule.logger.log('StreaksModule integrado - Sistema de rachas');
    AppModule.logger.log(
      'EventsModule integrado - Sistema de eventos/analytics',
    );
    AppModule.logger.log(
      'AiModule integrado - Generación de contenido con OpenAI',
    );
    AppModule.logger.log(
      'DashboardModule integrado - Estadísticas consolidadas',
    );
    AppModule.logger.log('ContactModule integrado - Formulario de contacto');
    AppModule.logger.log(
      'ChildrenProfilesModule integrado - Perfiles de niños',
    );
