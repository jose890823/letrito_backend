...
export class PaymentsController {
  ...
  // ============================================
  // LETRITO CHECKOUT ($7/mes)
  // ============================================

  @Post('checkout/letrito')
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Create Letrito Subscription Checkout',
    description: 'Creates a Stripe checkout session for Letrito subscription',
  })
  @ApiResponse({
    status: 201,
  ...
  async createLetritoCheckout(
    ...
    const result = await this.subscriptionsService.createLetritoCheckout(
      user.id,
      body.successUrl,
      body.cancelUrl,
    );
